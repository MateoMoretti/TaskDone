package my.life.tracker.finanzas.fragments
...
import my.life.tracker.databinding.FragmentTagsBinding
...
class FinanzasTagsFragment : Fragment() {
    ...
    private var adapterTags: my.life.tracker.finanzas.components.ListaTagsAdapter? = null
    ...
    private fun reloadData() {
        ...
        adapterTags =
            my.life.tracker.finanzas.components.ListaTagsAdapter(viewModel, currentTags, this)
